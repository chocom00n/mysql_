 ...
 */
public class ClaGestionSousCategories extends javax.swing.JFrame {

    private ClaConnectionBd oConnection = new ClaConnectionBd();    
    private Connection conn = null;
    // OMDB 29.03.2018 : Pouvoir sélectionner une ligne dans le SWING CONTROL TABLE à l'aide de la classe ClaSelectLigneJtable
    ClaSelectLigneJtable SelectLigneTab = new ClaSelectLigneJtable();
    ...
    /**
     * Creates new form GestionSousCategoriescopie
     */
    
    public ClaGestionSousCategories() {
    ...
    private void jTextField1_Nom_Sous_CategorieKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1_Nom_Sous_CategorieKeyReleased
        ...
        if (ClaValidation.validationChamp(jTextField1_Nom_Sous_Categorie.getText(),expression)) {
    ...
    private boolean ajouter_sous_categorie(String NomSousCategorie) {
        ...
        //String sql_insert_sc = "INSERT INTO T_labels (Name_Sub_category, nom_label) VALUES ('','"+NomSousCategorie+"');";
        String sql_insert_sc = "INSERT INTO T_labels (nom_label) VALUES (?);";
        //SELECT * FROM `T_labels` WHERE `nom_label` LIKE '%ni%' COLLATE utf8mb4_unicode_ci
        String sql_select_doublon = "SELECT *  FROM T_labels WHERE nom_label COLLATE utf8_unicode_ci LIKE ?";
        //String sql_select_doublon = "SELECT *  FROM T_labels WHERE nom_label COLLATE utf8_unicode_ci LIKE '"+NomSousCategorie+"'";
        try{
            
            // OMDB 13.03.2018 : "préparer" la requête (ici sans paramètres) pour la BD.
            PreparedStatement pst = ClaConnectionBd.getConnection().prepareStatement(sql_select_doublon);
            ...
            */
            ...
            if(count >= 1)
            {
                ...
                // OMDB 13.03.2018 : "préparer" la requête (ici sans paramètres) pour la BD.
                PreparedStatement pstInsert = ClaConnectionBd.getConnection().prepareStatement(sql_insert_sc);
                // OMDB 13.03.2018 : Passer la valeur au paramètre (défini par ?)
    ...
    private boolean remplir_table_sous_categories() {
        ...
        //String sql_select_sc = "SELECT * FROM T_labels";
      String sql_select_sc = "SELECT id_label, nom_label COLLATE utf8_unicode_ci as nom_label  FROM T_labels ORDER BY nom_label COLLATE utf8_unicode_ci ASC";
        //String sql_select_sc = "SELECT id_label, nom_label  FROM T_labels ORDER BY nom_label ASC";
        ...
        try{
            ...
            while(rs.next())
            {
                Object o[] = {rs.getInt("id_label"),rs.getString("nom_label")};
    ...
    private boolean update_sous_categorie(String nomsouscategorie, int idsouscategorie) {
        ...
        String sql_select_doublon = "SELECT * FROM T_labels WHERE nom_label LIKE ?";
        String sql_update_sc = "UPDATE T_labels SET nom_label = ? WHERE id_label = ?";              
        try{
            // OMDB 13.03.2018 : "préparer" la requête (ici sans paramètres) pour la BD.
            PreparedStatement pst = ClaConnectionBd.getConnection().prepareStatement(sql_select_doublon);
            ...
            */
            ...
            if(count >= 1)
            {
                ...
                try {
                    // OMDB 13.03.2018 : "préparer" la requête (ici sans paramètres) pour la BD.
                    PreparedStatement pstUpdate = ClaConnectionBd.getConnection().prepareStatement(sql_update_sc);
    ...
    private boolean delete_sous_categorie(int idsouscategorie) {
        ...
        String sql_delete_sc = "DELETE FROM T_labels WHERE id_label = ?";
        
        try{           
            PreparedStatement pst = ClaConnectionBd.getConnection().prepareStatement(sql_delete_sc);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClaGestionSousCategories.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new GestionSousCategoriescopie().setVisible(true);
            }
        });
    }
